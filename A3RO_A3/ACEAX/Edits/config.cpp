...
class XtdGearModels
{
	class CamoBase // Creating additional Camo Backgrounds for consistency. Colour Values taken from ACEAX.
	{
		...
		{
			label="Camo";
			image="\A3RO_A3\ACEAX\Edits\A3RO_M25_CAMO.paa";
		};	
		...
		{
			label="Camo";
			image="\A3RO_A3\ACEAX\Edits\A3RO_RPG32_RUCAM.paa";
		};
		...
		{
			label="Weathered";
			image="\A3RO_A3\ACEAX\Edits\A3RO_WEATHERED.paa";
		};		
	};
	class CfgWeapons // Changing Weapon Labels to the Names from A3RO_A3. Adding new Camos to ACEAX Models
	{
		class acebi_ak15
		{
		label="AK-15";
