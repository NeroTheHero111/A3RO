...
// MAAWS. Changing: Name. Description. As with Ammo, only changing Velocity with ACE loaded because I need its XM157 Framework to make the FCS function properly. The Vanilla Reticle would not align.
...
picture = "\A3RO_A3\Textures\UI\gear_nlaw_rocket_ca.paa";
};
...
{
descriptionShort = "Type: RF Datalink / Fire-And-Forget Anti-Personnel Missile<br />Rounds: 1<br />Arming Range: 50 Meters<br />Effective Range: 200 - 1200 Meters<br />Maximum Range: 1500 Meters<br />Used in: Mini-Spike";	
displayName = "MS-AP";
displaynameshort = "Anti-Personnel";
initSpeed = 20.117; // 18 is such a weird number.
mass = 88.1849;
};
class Titan_AT : Titan_AA // Mini-Spike was only developed with an Anti-Personell Warhead. an AT Warhead was planned but theres no evidence. However, Removing it would break faction balancing.
{
descriptionShort = "Type: RF Datalink / Fire-And-Forget Anti-Tank Missile<br />Rounds: 1<br />Arming Range: 50 Meters<br />Effective Range: 200 - 1200 Meters<br />Maximum Range: 1500 Meters<br />Used in: Mini-Spike";	
displayName = "MS-AT";
displaynameshort = "Anti-Tank";
initSpeed = 20.117;
mass = 132.2774; // *1,5 for balance
};