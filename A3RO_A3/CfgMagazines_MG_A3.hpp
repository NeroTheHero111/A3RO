...
initSpeed = 913.486;
mass = 75.1142;
picture = "\A3RO_A3\Textures\UI\icon_200Rnd_556x45_YRT_Box_F_CA.paa";
tracersEvery = 0;
};
...
initSpeed = 913.486;
picture = "\A3RO_A3\Textures\UI\icon_200Rnd_556x45_RRT_Box_F_CA.paa";
};
...
picture = "\A3RO_A3\Textures\UI\icon_200Rnd_556x45_YT_Box_F_CA.paa";
};
...
picture = "\A3RO_A3\Textures\UI\icon_200Rnd_556x45_RT_Box_F_CA.paa";
};
...
lastRoundsTracer = 0;
tracersEvery = 4;
picture = "\A3RO_A3\Textures\UI\icon_200Rnd_556x45_YT4_Box_F_CA.paa";
};
...
lastRoundsTracer = 0;
tracersEvery = 4;
picture = "\A3RO_A3\Textures\UI\icon_200Rnd_556x45_RT4_Box_F_CA.paa";
};
...
// Mk200 6.5 100Rnd Boxes. Changing: Name. Description. Calibre to 5.56. Ammocount to 100
class 200Rnd_65x39_cased_Box : 100Rnd_65x39_caseless_mag
{
ammo = "B_556x45_Ball_Tracer_Yellow";
count = 100;
descriptionShort = "Calibre: 5.56x45mm NATO<br />Rounds: 100<br />Tracers: Last 4 Rounds<br />Used in: Stoner 96";
displayName = "5.56x45 100Rnd Reload Tracer (Yellow) Stoner 96 Box";
displaynameshort = "Rel. Tr. (Yellow)";
initSpeed = 913.486;
mass = 34.4092;
lastRoundsTracer = 4;
picture = "\A3RO_A3\Textures\UI\icon_200Rnd_556x45_YRT_Stoner_CA.paa";
tracersEvery = 0;
};
...
initSpeed = 913.486;
mass = 34.4092;
picture = "\A3RO_A3\Textures\UI\icon_200Rnd_556x45_RRT_Stoner_CA.paa";
};
...
// Creating 5.56 100Rnd Tracer Every 4 and tracerless Boxes
...
displaynameshort = "Tr. 1 In 4 (Yellow)";
lastRoundsTracer = 0;
picture = "\A3RO_A3\Textures\UI\icon_200Rnd_556x45_YT4_Stoner_CA.paa";
tracersEvery = 4;
};
...
displaynameshort = "Tr. 1 In 4 (Red)";
lastRoundsTracer = 0;
picture = "\A3RO_A3\Textures\UI\icon_200Rnd_556x45_RT4_Stoner_CA.paa";
tracersEvery = 4;
};
...
picture = "\A3RO_A3\Textures\UI\icon_120Rnd_762x51_GT_CA.paa";
tracersEvery = 1;
};
...
lastRoundsTracer = 0;
picture = "\A3RO_A3\Textures\UI\icon_120Rnd_762x51_GT4_CA.paa";
tracersEvery = 4;
};
...
lastRoundsTracer = 4;
initSpeed = 843.077;
picture = "\A3RO_A3\Textures\UI\icon_100Rnd_762x51_GRT_NG7_CA.paa";
tracersEvery = 0;
mass = 67.0725;
...
displayNameShort = "Tracer (Green)";
lastRoundsTracer = 0;
picture = "\A3RO_A3\Textures\UI\icon_100Rnd_762x51_GT_NG7_CA.paa";
tracersEvery = 1;
};
...
displaynameshort = "Tr. 1 In 4 (Green)";
lastRoundsTracer = 0;
picture = "\A3RO_A3\Textures\UI\icon_100Rnd_762x51_GT4_NG7_CA.paa";
tracersEvery = 4;
};
...
// The above but for Red Tracers.
class 100Rnd_762x51_NG7_Box_RRT : 150Rnd_762x54_Box
{
ammo = "B_762x51_Tracer_Red";
displayName = "7.62x51 100Rnd Reload Tracer (Red) NG-7 Box";
displaynameshort = "Rel. Tr. (Red)";
picture = "\A3RO_A3\Textures\UI\icon_100Rnd_762x51_RRT_NG7_CA.paa";
};
class 100Rnd_762x51_NG7_Box_RT : 150Rnd_762x54_Box_Tracer
{
ammo = "B_762x51_Tracer_Red";
displayName = "7.62x51 100Rnd Tracer (Red) NG-7 Box";
displayNameShort = "Tracer (Red)";
picture = "\A3RO_A3\Textures\UI\icon_100Rnd_762x51_RT_NG7_CA.paa";
};
class 100Rnd_762x51_NG7_Box_RT4 : 100Rnd_762x51_NG7_Box_GT4
{
ammo = "B_762x51_Tracer_Red";
displayName = "7.62x51 100Rnd Tracer Every 4 (Red) NG-7 Box";
displaynameshort = "Tr. 1 In 4 (Red)";
picture = "\A3RO_A3\Textures\UI\icon_100Rnd_762x51_RT4_NG7_CA.paa";
};
...
picture = "\A3RO_A3\Textures\UI\icon_200Rnd_556x45_IRT_Box_F_CA.paa";
};
...
displayNameShort = "Tracer (IR-DIM)";
picture = "\A3RO_A3\Textures\UI\icon_120Rnd_762x51_IRT_CA.paa";
};
...
displayNameShort = "Tracer (IR-DIM)";
picture = "\A3RO_A3\Textures\UI\icon_100Rnd_762x51_IRT_NG7_CA.paa";
};
...
displayNameShort = "Tracer (IR-DIM)";
picture = "\A3RO_A3\Textures\UI\icon_200Rnd_556x45_IRT_Stoner_CA.paa";
};
...
picture = "\A3RO_A3\Textures\UI\icon_200Rnd_556x45_IRT4_Box_F_CA.paa";
};
...
displaynameshort = "Tr. 1 In 4 (IR-DIM)";
picture = "\A3RO_A3\Textures\UI\icon_120Rnd_762x51_IRT4_CA.paa";
};
...
displaynameshort = "Tr. 1 In 4 (IR-DIM)";
picture = "\A3RO_A3\Textures\UI\icon_100Rnd_762x51_IRT4_NG7_CA.paa";
};
...
displaynameshort = "Tr. 1 In 4 (IR-DIM)";
picture = "\A3RO_A3\Textures\UI\icon_200Rnd_556x45_IRT4_Stoner_CA.paa";
};