...
{
descriptionShort = "[ ONLY REPORT IF THIS ITEM MISSING BREAKS YOUR LOADOUT, ELSE JUST REMOVE ] Fictional Submachine Gun<br/>Calibre: 9x21mm";
displayName = "[ A3RO INCOMPATIBLE ] CPW 9x19";
...
{
descriptionShort = "[ ONLY REPORT IF THIS ITEM MISSING BREAKS YOUR LOADOUT, ELSE JUST REMOVE ] Fictional Submachine Gun<br/>Calibre: 9x21mm";
displayName = "[ A3RO INCOMPATIBLE ] MP5K-PDW";
picture = "\A3RO_A3\Textures\UI\a3ro_incompatible_item.paa";
scope = 1;
};
...
hiddenSelectionsMaterials[] = {"A3RO_A3\Textures\SMG_05_Semi_F.rvmat","\A3\Weapons_F_Exp\SMGs\SMG_05\Data\SMG_05_F_acc.rvmat"};
hiddenSelectionsTextures[] = {"A3RO_A3\Textures\SMG_05_Semi_F_co.paa","\A3\Weapons_F_Exp\SMGs\SMG_05\Data\SMG_05_F_acc_CO.paa"};
initSpeed = 314.859;
magazines[] = {"30Rnd_9x19_MP5_Mag"};
};
...
{
descriptionShort = "[ ONLY REPORT IF THIS ITEM MISSING BREAKS YOUR LOADOUT, ELSE JUST REMOVE ] Fictional Submachine Gun<br/>Calibre: 9x21mm";
displayName = "[ A3RO INCOMPATIBLE ] Scorpion EVO 3 A1";
picture = "\A3RO_A3\Textures\UI\a3ro_incompatible_item.paa";
scope = 1;
};
...
hiddenSelectionsMaterials[] = {"\A3RO_A3\Textures\smg_02_semi.rvmat","\A3\Weapons_F_Beta\SMGs\SMG_02\Data\smg_02_ammo.rvmat"};
hiddenSelectionsTextures[] = {"\A3RO_A3\Textures\smg_02_Semi_CO.paa","\A3\Weapons_F_Beta\SMGs\SMG_02\Data\smg_02_ammo_CA.paa"};
magazines[] = {"30Rnd_9x19_SMG_Mag"};
};
...
initSpeed = 401.117;
magazines[] = {"30Rnd_45ACP_Mag_SMG_01_NT"};
};
...
initSpeed = 373.99;
magazines[] = {"40Rnd_9x19_Vector_Mag"};
magazineWell[] = {"Vermin_9x19"};
scope = 2;
};

// Replacing Suppressor on Vector because it looks cooler
class SMG_01_Hamr_pointer_snds_lxWS : SMG_01_F
{
	class LinkedItems
	{
		class LinkedItemsMuzzle
		{
		item = "muzzle_snds_osprey_snd_F";
		slot = "MuzzleSlot";
		};
	};
};
