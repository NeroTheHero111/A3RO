...
initSpeed = 384.658;
picture = "\A3RO_A3\Textures\UI\gear_Pistol_heavy_02_PosFix_X_CA.paa";
};
class hgun_Pistol_heavy_01_green_F : hgun_Pistol_heavy_01_F
{
displayname = "FNX-45 Tactical (Green)";
picture = "\A3RO_A3\Textures\UI\gear_Pistol_heavy_02_PosFix_Khk_X_CA.paa";
};
...
initSpeed = 364.541;
picture = "\A3RO_A3\Textures\UI\gear_Acpc2_New_CA.paa"; // New
};
...
hiddenSelectionsTextures[] = {"A3RO_A3\Textures\Acpc2_black_2_co.paa"};
picture = "\A3RO_A3\Textures\UI\gear_Acpc2_Black_CA.paa";
};
...
initSpeed = 249.936;
picture = "\A3RO_A3\Textures\UI\gear_Pistol_Signal_01_Posfix_x_ca.paa";
};
