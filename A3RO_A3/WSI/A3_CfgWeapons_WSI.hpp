...
maxZeroing = 1200;
	...
	displayName = "3GL";
	initSpeed = 77.115; // Spitballing due to length. EGLM is 76, GLM is 75
...
maxZeroing = 2400;
	...
	class WeaponSlotsInfo // No Baseclass
	{
	mass = 93.6964;	
		class CowsSlot : asdg_OpticRail1913_long
		{
...
maxZeroing = 1800;
	...
	initSpeed = 518.16; // Using Alexander Arms Chart for 12'' Barrel for a lack of better reference points.
...
maxZeroing = 100;	
	...
	mass = 20.8125;
		...
		{
		iconPosition[] = {0.645,0.29};
		iconScale = 0.09;
		};
		class MuzzleSlot : asdg_MuzzleSlot_45ACP
		{
		iconPosition[] = {0.235,0.32};
		iconScale = 0.26;
		};
		class PointerSlot : asdg_PistolUnderRail
		{
		iconPosition[] = {0.43,0.62};
		iconScale = 0.22;
		};
	};
};
