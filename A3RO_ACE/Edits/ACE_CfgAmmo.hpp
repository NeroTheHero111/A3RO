...
ACE_dragModel = 7;
ACE_muzzleVelocities[] = {730,733.044,755.904,781.812,788,798.576,810,806.196,830};
ACE_standardAtmosphere = "ICAO";
...
{
ACE_caliber = 7.85;
ACE_ballisticCoefficients[] = {0.439};
...
ACE_dragModel = 7;
ACE_muzzleVelocities[] = {810,825,830,825}; // UK vz. 59L, PKM vz. 59, M84/PKP,
...
ACE_muzzleVelocities[] = {800,810,830,820}; // SVDM, SvDS, SVD/SVCh, SV98
...
ACE_bulletMass = 16.459;
ACE_muzzleVelocities[] = {780}; // No other Rifle with data on it.
...
ACE_muzzleVelocities[] = {790,807.72,810}; // Very sparse info. There are rifles with different lengths but ofcourse no velocity data...
...
ACE_muzzleVelocities[] = {870, 896.112};
audibleFire = 38.54;
hit = 9.05;
...
class M_Titan_AT : MissileBase // I Tried EVERYTHING. Any other Class than this WILL NOT LOCK PROPERLY. I DONT KNOW WHY. IM DONE. Bastardizing this. It kept breaking. Dont touch.
{
...
ace_frag_metal = 3000;
fuseDistance = 80.001; // 1/2 of Min Range. Based on vibes
...
class G_40mm_GP25_RLV_HEDP : G_40mm_HEDP
{
...
class G_35mm_QLG10A_DFJ10 : G_40mm_HEDP
{
ace_frag_charge = 35;
ace_frag_gurney_c = 2856.1;
ace_frag_gurney_k = 0.5;
