...
initSpeed = 75; // Based off Energa AT Rifle Grenade which is the only one I could find with a velocity
mass = 11.0231;
};
...
#include "\A3RO_CDLC_WS\CfgMagazines_762_WS.hpp"