...
{
descriptionShort = "Rocket Launcher<br />Tube: 105mm<br />Magnification: 2x"; // Ingame its actually 2.3 but I cant edit it until I fix the Reticule
displayName = "RPG-32 (Hex)";
    /*class OpticsModes Requires new Reticule
    {
        class optic
        {
...
{
descriptionShort = "Fire-And-Forget ATGM Launcher<br />Tube: 75mm<br />Magnification: 4x - 9x";	
